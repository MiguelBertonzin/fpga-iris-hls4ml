...
struct config2 : nnet::dense_config {
    ...
    typedef dense_8_bias_t bias_t;
    typedef dense_8_weight_t weight_t;
...
struct relu_config3 : nnet::activ_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned reuse_factor = 1;
    typedef dense_8_relu_table_t table_t;
};
...
struct config4 : nnet::dense_config {
    ...
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
    typedef dense_8_2_bias_t bias_t;
    typedef dense_8_2_weight_t weight_t;
...
struct relu_config5 : nnet::activ_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned reuse_factor = 1;
    typedef dense_8_2_relu_table_t table_t;
};
